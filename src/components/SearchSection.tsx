  ...
  const recentlyViewed = [
    {
      ...
      image:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/d5/f1/83/caption.jpg?w=100&h=-1&s=1",
    },
  ];
  ...
  return (
    <div className="px-4 md:px-6 pb-6 pt-2 mt-24">
      <motion.h1
        ...
        className="text-2xl md:text-5xl font-bold text-center mb-6"
      >
        {tabValues.map((tab) => (
      ...
      className="w-full flex justify-center mt-8 mb-4 overflow-x-auto pb-2 hide-scrollbar">
        <Tabs
          value={activeTab}
